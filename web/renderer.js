...
function skript(){
  ...
  const pythonProcess = spawn('python',[path_to_script, "-a",leftUpX, "-b",leftUpY, "-c", RightDownX ,"-d",RightDownY, "-e", filePath, "-f", heightOfVideo, "-g", widthOfVideo, "-h", sposob_odstranenia]);  //definujem co je ten moj skript
