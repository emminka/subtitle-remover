...
# Load the video
video_path = r'C:\Users\Emma\Desktop\Bakalarka\old\animated_ns.mp4'  # Replace with your video file path
cap = cv2.VideoCapture(video_path)

# Check if video file is opened successfully
if not cap.isOpened():
    print("Error: Could not open videdddo.")
    exit()
...
image_path = f'1ns.jpg'  # Replace with the desired image file path
